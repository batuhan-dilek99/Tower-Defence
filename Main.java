...
public class Main extends Application {
	...
	static final Image bossImage = new Image("file:images/boss.png");
	static final Image BOMBS_IMG[] = {
			new Image("file:images/enemy.png"),
			new Image("file:images/enemy.png"),
			new Image("file:images/enemy.png"),
			new Image("file:images/enemy.png"),
			new Image("file:images/enemy.png"),
	...
	private void run(GraphicsContext gc) {
		...
		if(score % 5 == 0 && score != 0) {
			Boss boss = new Boss(400, 300, 100, bossImage);
			boss.update();
			boss.draw();
	...
	public class Boss extends Bomb{
		
		boolean isBossActive;
		int health;
		Boss(int posX, int posY, int size, Image image){
			super(posX, posY, size, image);
			isBossActive = true;
			health = 10;
		}
	...
	public class Shot {
		...
		public boolean bossColide(Boss other) {
			int d = distance(this.posX + size / 2, this.posY + size /2, 
							other.posX + other.size / 2, other.posY + other.size / 2);
			return d < other.size / 2 + this.size / 2 ;
		}
